create or replace PACKAGE BODY dc_k_util_json_web IS
  ...
  --
  FUNCTION fl_is_primitive(p_json_value IN tron2000.json_value_web) RETURN BOOLEAN IS
    --
  ...
  --
  FUNCTION fl_get_json_value(p_json_value IN tron2000.json_value_web) RETURN VARCHAR2 IS
  BEGIN
    --
  ...
  PROCEDURE pl_lee_json(p_json IN json) IS
    --
    l_json_value  tron2000.json_value_web;
